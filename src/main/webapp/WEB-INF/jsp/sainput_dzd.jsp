            ...
            <section class="wrapper site-min-height">
              <section class="panel">
                <header class="panel-heading">
                  <span class="label label-primary">收付款对账单</span>
                  <div class="btn-group pull-right">
                              <button class="btn btn-primary dropdown-toggle"  onClick="window.open('dzPrint.html')" data-toggle="dropdown">打印预览</i>
                              </button>
                           </div>
                </header>
                        ...
                        <table class="table table-striped table-hover table-bordered" id="editable-sample">
                           <thead>
                              <tr>
                                 ...
                                 <th class="hidden-phone">箱号</th>
                                 <th class="hidden-phone">收货人</th>
                                 <th class="hidden-phone">送货地址</th>
                                 <th>派送日期</th>
                                 <th>驾驶员</th>
								 <th class="hidden-phone">收付款单位</th>
                                 <th>收付款项目</th>
                                 <th>应收款</th>
								 <th>应付款</th>
                              </tr>
                           ...
                           <tbody>
                             <tr class="">
                                 ...
                                 <td class="center hidden-phone">成都市成华区</td>
                                 <td>2017-06-08</td>
								 <td>李四</td>
								 <td>xxxxxxxx</td>
								 <td>应收****费</td>
