		...
		<center>
			<table width="1018" border="2" style="border-collapse: collapse;">
				...
				<tr height="19">
					...
					<td x:str height="19" width="172">出票单位</td>
					<td x:str height="19" width="100">款票面金额</td>
					<td x:str height="19" width="72">付发票点</td>
					<td x:str height="19" width="72"> 付票款</td>
				</tr>

				<c:forEach items="${billPrintList}" var="bill" varStatus="status">
					<tr height="19">
