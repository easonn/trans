	...
	<section class="wrapper site-min-height">
		<section class="panel">
			<header class="panel-heading">
				<span class="label label-primary">派车发货收入清单</span>
			...
			<div class="panel-body">
				<div class="adv-table editable-table ">
					...
					<table class="table table-striped table-hover table-bordered"
						...
						<tbody>
							<c:forEach items="${incomesList}" var="income" varStatus="status">
	...
	<script type="text/javascript">
		...
		function sprint() {
			...
			if (i == 0) {
				...
				alert(text)
				window.open('/income/income_s_print?incomeIdList=' + text);
			}
		};
	</script>
	<!-- END JS -->
